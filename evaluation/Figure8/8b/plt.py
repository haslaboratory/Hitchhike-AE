...
colors = ['#808080', '#b5b49c', '#4c6a92', '#6c8c98', '#3f51b5', '#ff6600']
...
for i, (file, y_values) in enumerate(file_y_values.items()):
    ...
    plt.plot(np.arange(len(all_x_values)), y_positions, color=next(color), label=label[i], marker=next(marker), markersize=9, linewidth=2, linestyle='-')
